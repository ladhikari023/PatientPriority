/* Laxman Adhikari
   ...
   In this c file, I have written all the functions that are required for the 
   program to work. One of the function process is called in from main program 
   with parameters of reading and writing files. Then, from process function, all
   other functions are called for specific purpose. I have commented each function
   on what it is doing.
*/ 
...
/*Reads input along with sorting and printing of list*/
...
/*
   This function is called from main program with a read file and write file.
   First an int waiting is assigned to read_input and till read_input returns 1,
   the while loop runs.
*/
...
/*Sort the list on the basis of pain, age, and waiting time given in the pdf*/ 
...
/*Compare waiting time of the patient*/
...
/*when one patients is listed, this function increases the time by 15 mins*/
...
/*returns waiting time of a patient*/
...
/*Releases memory allocated for inputheads*/
void release_mem()
{
   log_t *ptr;
